...
export default function DriverTable({
  ...
  // The three relocated fields (Group/Customer, Driver Class, Operating
  // Hours) stay hidden from the editable Create Driver grid but still show
  // in read-only views (e.g. a completed Modify Driver request) since those
  // fields can still carry real values through even though no form edits
  // them anymore. Document uploads are shown inline only while editing -
  // completed requests list them via AttachmentsList instead.

...
export function buildSeed() {
  ...
  const drivers = [
    ...
    { id: 3, requestId: 2, username: 'ahmad.kabbani@asmo.com', firstName: 'Ahmad', lastName: 'Kabbani', email: 'ahmad.kabbani@asmo.com', phone: '0552112332', role: 'Privileged User', customerGroup: 'CUEU/ARCO', driverClass: '30Ton_Drivers', operatingHours: 'Sun-Thu 8:00-17:00', poNumber: '4821211244768', poExpiry: '2027-05-19' },

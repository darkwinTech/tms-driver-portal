...
export const DRIVER_FIELDS = [
  ...
  { key: 'licenseNumber', label: 'Driver License/ID/IQAMA Number (CR)', placeholder: "Enter driver's License, National ID, or IQAMA Number.", required: true, createOnly: true },
  { key: 'licenseExpiry', label: 'Driver License Expiration Date (CR)', type: 'date', required: true, createOnly: true },
  { key: 'IDExpiry', label: 'Driver ID/IQAMA Expiration Date (CR)', type: 'date', required: true, createOnly: true },
